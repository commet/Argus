...
export function translate(
  ...
  // Empty strings are intentional for locale-specific affixes such as the
  // English birth-year/month suffixes. Truthiness fallback leaked Korean text
  // into English pages whenever a translation deliberately rendered nothing.
