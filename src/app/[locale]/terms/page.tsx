    ...
    <div className="max-w-2xl mx-auto px-5 py-12">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-[14px] text-[var(--text-primary)] leading-relaxed">
        <section>
          ...
          <p>{L(
            '이 약관은 Argus(이하 "회사" 또는 "서비스")를 이용하는 회원(이하 "이용자")과 회사 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.',
            'These Terms set out the rights, obligations, and responsibilities between Argus (hereinafter "the Company" or "the Service") and members who use it (hereinafter "Users").',
          )}</p>
        </section>
