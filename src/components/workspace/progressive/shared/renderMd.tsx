...
function renderLine(l: string, k: number): React.ReactNode {
  ...
  if (l.startsWith('> ')) return <blockquote key={k} className="rounded-lg bg-[var(--accent)]/[0.04] px-4 py-2.5 text-[14px] text-[var(--text-secondary)] italic my-3 leading-[1.65]">{renderInline(l.slice(2))}</blockquote>;
