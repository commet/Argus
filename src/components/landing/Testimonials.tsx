  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto px-6 md:px-10 text-center">
        ...
        >
          {L('직접 써보고 남긴 말이에요.', 'What an early user said after trying it.')}
        </h2>
        ...
        <p
          ...
          style={{ color: 'var(--bp-ink-soft)', fontSize: 11.5, letterSpacing: locale === 'ko' ? '0.04em' : '0.16em' }}
        >
