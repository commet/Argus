...
export const SCENARIOS = [
  ...
  {
    id: 'heavy-10-launch-baseline',
    group: 'heavy',
    locale: 'ko',
    opening:
      '오래 준비한 서비스를 이번 주에 공개하려고 하는데, 아직 고칠 게 계속 보여서 지금 홍보를 시작해도 될지 모르겠어. 늦추면 기회를 놓칠 것 같고, 내보냈다가 첫인상을 망칠까 걱정돼.',
    baseline:
      '이번 주에 공개하되, 첫 사용자에게 치명적인 오류만 더 확인하고 홍보를 시작하고 싶다.',
    replies: [
      '사실 정해진 행사나 고객 약속은 없어. 경쟁 서비스가 먼저 알려질까 불안하고, 오래 미룬 만큼 이번 주에는 끝내고 싶다는 마음이 커.',
      '가입과 첫 결과 생성이 막히는 오류만 치명적이라고 볼게. 나머지는 공개 뒤에도 고칠 수 있어.',
    ],
    expect: { route: 'heavy', requestType: 'open' },
    deepenRounds: 2,
    notes: '실사용 회귀: 검토 전 기준점이 이미 "공개하되 치명적 오류만"이라고 정했다. 첫 질문이 공개/연기 또는 치명적 기준을 다시 묻거나, 답 뒤 무엇이 바뀌었는지 보이지 않으면 실패.',
  },
];
