...
- **Wire moves to `argus-decision-mcp@1.12.1`** — hidden-assumption
  drafting learns the most-missed class (the untouched side: what the
  plan assumes stays true about what it leaves alone).
